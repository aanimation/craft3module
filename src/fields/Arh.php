...
namespace modules\arhammodule\fields;

use modules\arhammodule\Arhammodule;
use modules\arhammodule\assetbundles\arhfield\ArhFieldAsset;
...
class Arh extends Field
{
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'arhammodule/_components/fields/Arh_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(ArhFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').ArhammoduleArh(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'arhammodule/_components/fields/Arh_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,

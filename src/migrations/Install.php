...
namespace modules\arhammodule\migrations;
...
class Install extends Migration
{
    ...
    // arhammodule_arh table
        $tableSchema = Craft::$app->db->schema->getTableSchema('{{%arhammodule_arh}}');
        if ($tableSchema === null) {
            $tablesCreated = true;
            $this->createTable(
                '{{%arhammodule_arh}}',
    ...
    // arhammodule_arh table
        $this->addForeignKey(
            $this->db->getForeignKeyName('{{%arhammodule_arh}}', 'siteId'),
            '{{%arhammodule_arh}}',
            'siteId',
            '{{%sites}}',
            'id',
    ...
    {
    // arhammodule_arh table
        $this->dropTableIfExists('{{%arhammodule_arh}}');
    }
}

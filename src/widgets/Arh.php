...
namespace modules\arhammodule\widgets;

use modules\arhammodule\Arhammodule;
use modules\arhammodule\assetbundles\arhwidget\ArhWidgetAsset;
...
class Arh extends Widget
{
    ...
    {
        return Craft::getAlias("@arhammodule/assetbundles/arhwidget/dist/img/Arh-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'arhammodule/_components/widgets/Arh_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(ArhWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'arhammodule/_components/widgets/Arh_body',
            [
